...
const topicsBySystemPratica = [
  {
    ...
    topics: [
      ...
      },
      {
        ...
        description: "Cintura escapular, braço, antebraço e mão - estrutura óssea completa",
        icon: Bone,
        available: true,
      },
      {
        ...
        description: "Vascularização arterial e venosa completa do membro superior",
        icon: Activity,
        available: true,
      },
    ],
    ...
    topics: [
      {
        ...
        description: "Anatomia detalhada dos músculos do quadril, coxa, perna e pé",
        icon: Dumbbell,
        available: true,
      },
      {
        ...
        description: "Quadril, coxa, perna e pé - estrutura óssea completa",
        icon: Bone,
        available: true,
      },
      {
        ...
        description: "Vascularização arterial e venosa completa do membro inferior",
        icon: Activity,
        available: true,
      },
    ],
    ...
    topics: [
      {
        ...
        description: "Plexos braquial e lombossacral, distribuição nervosa dos membros",
        icon: Zap,
        available: true,
      },
    ],
    ...
    topics: [
      {
        id: "cranio",
        title: "Crânio",
        description: "Anatomia óssea do crânio, neurocrânio e viscerocrânio",
        icon: Skull,
        available: true,
      },
      {
        ...
        description: "Musculatura facial, vascularização e inervação da face",
        icon: User,
        available: true,
      },
    ],
    ...
    topics: [
      {
        ...
        description: "Anatomia da parede torácica e trato gastrointestinal",
        icon: Utensils,
        available: true,
      },
      {
        ...
        description: "Espaço retroperitoneal, rins, ureteres, bexiga e uretra",
        icon: Droplet,
        available: true,
      },
    ],
    ...
    topics: [
      {
        id: "coracao",
        title: "Coração",
        description: "Anatomia cardíaca detalhada, câmaras, valvas e vascularização",
        icon: Heart,
        available: true,
      },
    ],
    ...
    topics: [
      {
        ...
        description: "Vias aéreas, pulmões e anatomia cervical completa",
        icon: Lungs,
        available: true,
      },
    ],
    ...
    topics: [
      {
        id: "articulacoes",
        title: "Articulações",
        description: "Anatomia detalhada das articulações do corpo humano",
        icon: Activity,
        available: true,
      },
    ],
