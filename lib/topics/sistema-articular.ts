...
export const sistemaArticular: TopicContent = {
  ...
  content: {
    sections: [
      ...
      {
        title: "Aspectos Clínicos e Envelhecimento",
        content: [],
        subsections: [
          {
  ...
  questions: [
    {
      question:
        "Descreva a diferença entre a classificação estrutural e a classificação funcional das articulações. Cite o critério central em que se baseia a classificação estrutural.",
      options: [
        "Não há diferença entre as classificações",
        "Classificação estrutural baseia-se no material de união e presença de cavidade articular; classificação funcional baseia-se na amplitude de movimento",
        "Ambas se baseiam apenas na mobilidade",
        "Classificação estrutural considera apenas os ligamentos",
      ],
      correctAnswer: 1,
      explanation:
        "A classificação estrutural se baseia no material que une os ossos (e na presença/ausência de cavidade articular). A classificação funcional se baseia na amplitude de movimento permitida (podendo ser em torno de nenhum, um, dois ou três eixos). O critério central da classificação estrutural é o material de união.",
    },
    {
      question:
        "As articulações do ombro e do quadril (ambas sinoviais) apresentam amplitudes de movimento distintas. Explique essa diferença sob a perspectiva da anatomia funcional e da locomoção.",
      options: [
        "Ambas têm a mesma amplitude de movimento",
        "Quadril prioriza estabilidade para sustentação e locomoção; ombro prioriza mobilidade para apreensão e gesticulação",
        "Ombro é menos móvel que o quadril",
        "Não há relação entre estrutura e função",
      ],
      correctAnswer: 1,
      explanation:
        "De acordo com a anatomia funcional, a forma da estrutura suporta a função. A articulação do quadril (membro inferior) tem mobilidade reduzida porque sua função primária é sustentação e locomoção, exigindo maior estabilidade. Já o ombro (membro superior) tem maior mobilidade (mas menor estabilidade) para cumprir sua função principal de apreensão e gesticulação, facilitando a interação com o meio.",
    },
    {
      question:
        "O que são diartroses e qual tipo de articulação estrutural se encaixa totalmente nessa classificação funcional? Mencione uma característica estrutural obrigatória desse tipo de articulação.",
      options: [
        "Diartroses são articulações imóveis; articulações fibrosas",
        "Diartroses são articulações livremente móveis; articulações sinoviais; característica obrigatória é a cavidade articular preenchida por líquido",
        "Diartroses são articulações parcialmente móveis; articulações cartilaginosas",
        "Diartroses não existem no corpo humano",
      ],
      correctAnswer: 1,
      explanation:
        "Diartroses são articulações livremente móveis. O tipo de articulação estrutural que se encaixa totalmente nessa classificação funcional é a articulação sinovial. Uma característica estrutural obrigatória das articulações sinoviais é a presença de uma cavidade articular preenchida por líquido.",
    },
    {
      question:
        "Em que consiste a artroscopia e por que ela é preferida em relação à radiografia simples para a avaliação de lesões articulares, dada a natureza dos elementos que compõem uma articulação (além dos ossos)?",
      options: [
        "Artroscopia é um tipo de radiografia; não há diferença",
        "Artroscopia é método de escolha para diagnóstico de lesões articulares; é mais eficiente porque avalia tecidos moles (cartilagem, ligamentos) que a radiografia não visualiza bem",
        "Radiografia é sempre melhor que artroscopia",
        "Artroscopia só avalia ossos",
      ],
      correctAnswer: 1,
      explanation:
        "A artroscopia é o método de escolha para o diagnóstico de lesões articulares. Ela é preferida porque, além dos ossos, as articulações são compostas por tecidos moles como cartilagem e ligamentos. A artroscopia é mais eficiente do que a radiografia porque esta última (que usa raios X) é primariamente excelente para ossos e estruturas densas, mas pode não fornecer o detalhe necessário dos tecidos moles dentro da articulação.",
    },
    {
      question:
        "O sistema esquelético sozinho não forma o aparelho locomotor. Quais são os outros dois sistemas que, em conjunto, o constituem? Qual o papel de cada um desses dois sistemas (exceto o esquelético) nesse aparelho?",
      options: [
        "Sistema nervoso e circulatório; controle e nutrição",
        "Sistema articular e sistema muscular; sistema articular une ossos e permite mobilidade; sistema muscular fixa-se aos ossos e gera movimento",
        "Sistema digestório e respiratório; nutrição e oxigenação",
        "Apenas o sistema esquelético forma o aparelho locomotor",
      ],
      correctAnswer: 1,
      explanation:
        "Os outros dois sistemas são o sistema articular e o sistema muscular. O papel do sistema articular é unir os ossos e permitir mobilidade. Embora o sistema muscular não seja detalhado neste capítulo, os músculos fixam-se aos ossos e utilizam-nos como alavancas, sendo essenciais para o movimento do corpo (função do músculo esquelético).",
    },
  ],
}
